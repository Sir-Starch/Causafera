...
- **"Contribution"** means any source code, documentation, artwork, design, data, configuration, or other material intentionally submitted to the Project for inclusion, including submissions via pull request, issue comment, email, or any other communication channel.
...
The Project will maintain accurate attribution of all Contributions. You will be credited in the commit history, CONTRIBUTORS file, or other appropriate place. The Project may remove attribution only if the Contribution is removed from the codebase.

## 8. Termination

You may terminate this CLA by providing written notice to the Project maintainers. Termination does not affect licenses already granted for Contributions submitted prior to termination. Contributions submitted before termination remain subject to this CLA in perpetuity.
...
The Project will retain an acceptance record identifying at least You, Your verified account or electronic identity, the CLA version, the acceptance timestamp, and the pull request or commit associated with the acceptance. The acceptance applies to future Contributions submitted through that identity unless the acceptance record states a narrower scope.
...
This CLA constitutes the entire agreement between You and the Project regarding Contributions and supersedes all prior agreements, understandings, and representations.
...
**Questions?** Open an issue or contact the maintainers before submitting your first contribution if you have concerns about this CLA.

**Legal review notice:** This CLA is project policy, not legal advice. Before accepting external Contributions, the Project Maintainer should have this text and the electronic acceptance process reviewed by a Netherlands-qualified lawyer experienced in intellectual property and open-source licensing.

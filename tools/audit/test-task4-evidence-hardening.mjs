...
import { LEGACY_BASELINE_TYPES_SOURCE_PATH, ROOT, canonical } from './lib/validate-capability-audit-core.mjs';
...
try {
  ...
  withEvidence('forged-integration-target', (root) => {
    ...
    reconciliation.targets[0].path = LEGACY_BASELINE_TYPES_SOURCE_PATH;

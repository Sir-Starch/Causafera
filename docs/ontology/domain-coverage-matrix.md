...
| Energy | Fixed-point thermal-energy carrier with conserved same-chart intra-chunk and cross-chunk transfer, finite historical-bootstrap reservoirs, and exact conservation accounting | M2 | Thermal-to-material coupling, cross-chart transport, climate/biology integration, and economy |

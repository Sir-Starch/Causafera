...
**Status:** Pending — unblocked by `TODO-RUNTIME-002`; the decision of `chunk_extent` 6 must be re-taken against a populated field and re-validated across seeds

...
The isekai subsystem lives in the `causafera-isekai` crate. It models cross-world transfer: the physical or metaphysical processes by which agents, objects, information, or patterns move between Causafera and other worlds (including Earth).

## Core Principle

Cross-world transfer must be a physical or metaphysical process, not a narrative convenience. The subsystem must model what actually happens when something crosses between worlds, what properties persist, what is lost, and how the transferred entity interacts with Causafera causality.
...
Transferred entities are physical presences in Causafera. They occupy space, consume resources, produce waste, and participate in causal chains.
...
- **Language**: Transferred agents may speak languages unknown in Causafera

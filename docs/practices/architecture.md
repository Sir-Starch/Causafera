...
Execution emits proposed action patterns with relative timing. It cannot directly mutate authoritative state. A future scheduler system must validate physical capability, materials, access, and conflicts before commit.

Practice mutation creates a child lineage by replacing a validated instruction. This supports copying error and drift while preserving ancestry. Full imitation, coordinated roles, resource bindings, and social diffusion are future work.

...
pub struct ActorSubjectiveSnapshot {
    ...
    pub attention: causafera_cognition::AttentionStateSnapshot,
...
pub enum ActorInitError {
    ...
    Attention(#[from] causafera_cognition::AttentionConfigError),
    #[error("actor scene configuration failed: {0}")]
    SceneConfig(#[from] causafera_cognition::SceneConfigError),
    #[error("actor scene initialization failed: {0}")]
    SceneUpdate(#[from] causafera_cognition::SceneUpdateError),
}

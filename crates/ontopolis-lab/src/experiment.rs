...
fn build_recovery_frame(
...
) -> Result<ontopolis_explanation::ExplanationFrame, ExperimentError> {
    let traces = recovery
    ...
    ontopolis_explanation::ExplanationFrame::new(
        checkpoint_time,
...
pub enum ExperimentError {
    ...
    #[error(transparent)]
    Explanation(#[from] ontopolis_explanation::ExplanationIrError),
}

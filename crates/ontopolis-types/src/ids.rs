...
define_id!(HistoricalBootstrapId, u64);
define_id!(HistoricalStageId, u64);
define_id!(HistoricalProcessSchemaId, u64);
define_id!(CrossWorldTransferId, u64);
define_id!(TransferMechanismSchemaId, u64);
define_id!(TransferPayloadId, u64);
define_id!(SourceWorldId, u64);
define_id!(ImportedPriorId, u64);
define_id!(CapabilityResourceSchemaId, u64);
define_id!(IdentityExperimentId, u64);
define_id!(ContinuityCandidateId, u64);
define_id!(ContinuityObservationId, u64);
define_id!(ContinuityEvidenceChannelId, u64);
define_id!(ContinuityCriterionSchemaId, u64);
define_id!(AttractorExperimentId, u64);
define_id!(AttractorProbeSchemaId, u64);
define_id!(ExperimentId, u64);
define_id!(WorldGeometrySchemaId, u64);
define_id!(SpatialChartId, u64);
define_id!(LocalFrameId, u64);

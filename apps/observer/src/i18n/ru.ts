...
export const ru: Copy = {
  ...
  connection: {
    ...
    capTitle: "Прогон достиг предела экспорта",
    capBody:
      "Следующий такт дал бы состояние крупнее конверта снимка в 256 МиБ, поэтому среда отклонила его целиком и оставила сессию ровно такой, какой она была. Ни одно принятое состояние не имеет права стать неэкспортируемым. Карта из девяти чанков с гидрологией накапливает причинные трассы и квитанции переносов достаточно быстро, чтобы упереться в предел за десятки тактов; «Сброс» начинает новый прогон.",
  ...
  station: {
    ...
    water: "Вода, всего",
    waterStanding: "Стоящая вода",
    waterTitle: "Запасы воды",
    waterLede:
      "Три хранилища друг против друга. В замкнутом контуре сумма постоянна по построению; меняется то, в каком из хранилищ вода находится.",
    waterOpenChart: "Показать на карте",
    waterLedger: "Водный баланс",
    waterLedgerLede:
      "Итоги за всю сессию и последняя применённая запись форсинга с её происхождением.",
    waterSurface: "Поверхность",
    waterSoil: "Почва",
    waterGround: "Подземные воды",
    waterConveyance: "Русла",
    waterChunks: "Чанков с водой",
    waterResidualZero: "Баланс сведён · невязка 0",
    waterForcing: "Последний форсинг",
    waterNoForcing: "Ни одна применённая запись больше не подтверждена",
    waterAccepted: "Принятый приход",
    waterEvapotranspiration: "Принятый расход",
    waterOrigin: "Происхождение",
    waterDisabled: "нет в этом мире",
    waterDisabledBody:
      "В этой сессии воды нет: гидрология выключена в конфигурации. Это факт о прогоне, а не пробел в приборе.",
    waterUnreported:
      "Эта посылка записана до появления гидрологии и о воде не говорит ничего — ни в ту, ни в другую сторону.",
  },
  ...
  chart: {
    ...
    water: "Вода",
    waterLede: "Просуммировано по решёткам ячеек, которые держит эта сессия, а не по агрегату чанка.",
    noWaterLattice: "Решётка воды для этого чанка не получена.",
  ...
  flux: {
    ...
    quantity: "Величина",
    total: "Всего",
    water: "Перемещения воды",
    waterLede:
      "Не более 64 перемещений, в каноническом порядке носителей, для последней удержанной партии. Каждое принятое, частично принятое и полностью отклонённое идёт со всеми тремя объёмами, потому что сработавший ограничитель — это свидетельство: показывать только сдвинувшееся значило бы сделать работающую границу неотличимой от процесса, которому нечего было делать. Окно — срез такта, а не его перепись.",
    waterProcess: "Процесс",
    waterRequested: "Запрошено",
    waterAccepted: "Принято",
    waterUnaccepted: "Не принято",
    waterAcceptance: "Доля",
    waterOrigin: "Якорь",
    waterOriginHint: "Запись форсинга, от которой происходит это перемещение",
    waterLimited: "ограничено в окне",
    waterUnlimited: "в окне ничто не ограничено",
    waterCells: "Изменения ячеек воды",
    waterCellsLede:
      "Не более 64 изменившихся ячеек, в каноническом порядке адресов — первые по адресу, а не наибольшие изменения и не выборка того, где двигалась вода. Каждая строка — зафиксированные «до» и «после» одной ячейки с породившими их членами форсинга и латерального потока.",
    waterForcingTerm: "Форсинг",
    waterLateral: "Латеральный",
    noWater: "В окне нет перемещений воды",
    noWaterBody:
      "Либо в этой сессии нет воды, либо внутри ограниченного окна ничего не двигалось. И то и другое — результат наблюдения, а не пробел.",
  },
